...
export const PaymentMethods = {
  ...
  Cod: new PaymentMethod("Utánvét", "cash on delivery"),
  Simple: new PaymentMethod("SimplePay", "simplepay"),
  Cheque: new PaymentMethod("Csekk", "cheque"),
  ElectronicFundsTransfer: new PaymentMethod(
    "Elektronikus átutalás",
    "electronic funds transfer"
  ),
  MobilePayment: new PaymentMethod("Mobilfizetés", "mobile payment"),
  Cryptocurrency: new PaymentMethod("Kriptovaluta", "cryptocurrency"),
  InvoiceFinancing: new PaymentMethod(
    "Számlafinanszírozás",
    "invoice financing"
  ),
  OnlinePaymentGateway: new PaymentMethod(
    "Online fizetési átjáró",
    "online payment gateway"
  ),
  CashiersCheck: new PaymentMethod("Pénztári csekk", "cashier's check"),
};
